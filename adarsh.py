...
bot = telebot.TeleBot('8558959863:AAFtKyTG4kMBaFNmyCWubU8n480XMvgIZTE')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @MR_ADARSH_YTs & @iam666bro"
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀᴘᴘʀᴏᴠᴇ ʙʏ ᴀᴅᴍɪɴ ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @MR_ADARSH_YTs & that's brother @iam666bro"
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"🚩𝐇𝐄𝐘 -> {username} \n🔺𝘼𝙏𝙏𝘼𝘾𝙆🔻1--> [𝐒𝐓𝐀𝐑𝐓𝐄𝐃]\n\n†αrgε† -> {target}\np⊕r† -> {port}\n†ïmε -> {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\ngαmε --> 🇮🇳🅑🅖🅜🅘🇮🇳\n\n彡[JAY SHREE KRISHNA/RAM 🚩 @MR_ADARSH_YTs & that's brother @iam666bro]彡"
    bot.reply_to(message, response)
...
def show_command_logs(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "ᴘʟᴇᴀꜱᴇ ᴄᴏɴᴛᴀᴄᴛ --> @SMR_ADARSH_YTs"
...
𝘽𝙪𝙮 :- @Uvaissiddiqui86
𝙊𝙛𝙛𝙞𝙘𝙞𝙖𝙡 :- @Uvaissiddiqui86 and that's brother @iam666bro 
'''
