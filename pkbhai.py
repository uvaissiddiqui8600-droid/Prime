...
TOKEN = '8594216898:AAEKPBQl0zzsZS34rqi2hqTsN71T4zjp7gY'  # Replace with your actual bot token
ADMIN_IDS = [7820814565]  # Added new admin ID
CHANNEL_ID = '-1003524093054'  # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [000009, 1000000004]
...
def reset_attack_limit(message):
    owner_id = 190000007  # Replace with the actual owner ID
...
FEEDBACK_CHANNEL_ID = "-10000000039"  # Replace with your actual feedback channel ID
